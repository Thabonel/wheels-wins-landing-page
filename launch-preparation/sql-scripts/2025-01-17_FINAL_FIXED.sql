-- =========================================================================
-- CREATE MISSING TABLES - FINAL FIXED VERSION
-- =========================================================================
-- Date: January 17, 2025
-- Purpose: Create missing tables with correct data types and no problematic indexes
-- Execute this in Supabase SQL Editor
--
-- FIX: Removed problematic index that referenced columns before table creation
-- =========================================================================
...
-- =========================================================================
-- ENABLE ROW LEVEL SECURITY (RLS) FIRST
-- =========================================================================
...
-- Fixed: Create the active recommendations index AFTER the table exists
...
-- =========================================================================
--
-- ✅ This script fixes the execution order:
-- 1. Create tables first
-- 2. Enable RLS
-- 3. Create policies
-- 4. Create indexes (including the problematic is_active index)
-- 5. Create triggers and permissions
--
-- All "table doesn't exist" errors should now be resolved!
-- =========================================================================