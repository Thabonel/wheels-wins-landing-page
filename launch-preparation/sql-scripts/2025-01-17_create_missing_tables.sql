-- Create Missing Database Tables for Wheels & Wins Launch
...
CREATE INDEX idx_income_entries_type ON public.income_entries(type);
...
CREATE INDEX idx_user_wishlists_category ON public.user_wishlists(category);
CREATE INDEX idx_user_wishlists_priority ON public.user_wishlists(priority);
...
CREATE INDEX idx_trip_template_ratings_template_id ON public.trip_template_ratings(template_id);
CREATE INDEX idx_trip_template_ratings_user_id ON public.trip_template_ratings(user_id);
CREATE INDEX idx_trip_template_ratings_rating ON public.trip_template_ratings(rating);
...
CREATE TRIGGER update_trip_template_ratings_updated_at BEFORE UPDATE ON public.trip_template_ratings FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
