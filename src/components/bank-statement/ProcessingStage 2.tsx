...
export const ProcessingStage: React.FC<ProcessingStageProps> = ({ file, session, onComplete }) => {
  ...
  const processFile = async () => {
    try {
      ...
      console.log('Anonymizing transactions. Input count:', rawTransactions.length);
      ...
      console.log('Anonymized transactions count:', transactions.length);
      console.log('Sample anonymized transaction:', transactions[0]);
      ...
      console.log('Categorizing transactions. Input count:', transactions.length);
      const categorizedTransactions = await categorizeTransactions(transactions);
      console.log('Categorized transactions count:', categorizedTransactions.length);
