...
const Hero = () => {
  return <section className="w-full h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8">
        <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 drop-shadow-lg">The Traveller's Guide to Roadside Riches</h1>
        <p className="text-xl md:text-2xl text-white/90 mb-10 max-w-3xl mx-auto">Discover the Freedom of the Open Road with Expert Resources Designed for Mature Travelers.

Meet Pam, Your Smart Travel Companion
Pam is your AI assistant who helps you plan your trip, manage your money, and stay stress-free on the road.</p>
