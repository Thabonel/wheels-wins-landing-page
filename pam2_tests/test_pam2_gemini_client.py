...
os.environ.setdefault("GEMINI_API_KEY", "<GOOGLE_TOKEN>")
os.environ.setdefault("ANTHROPIC_API_KEY", "<ANTHROPIC_TOKEN>")
...
os.environ.setdefault("PAM2_GEMINI_API_KEY", "<GOOGLE_TOKEN>")
os.environ.setdefault("PAM2_ANTHROPIC_API_KEY", "<ANTHROPIC_TOKEN>")
