...
OPENAI_API_KEY=           <OPENAI_API_KEY> AI services
SUPABASE_URL=             # Database connection  
SUPABASE_ANON_KEY=        <SUPABASE_ANON_KEY> Client-side auth
SUPABASE_SERVICE_ROLE_KEY= <SUPABASE_SERVICE_ROLE_KEY> Server-side admin
