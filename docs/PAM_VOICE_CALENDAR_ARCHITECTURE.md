...
### Backend (.env)
```bash
ANTHROPIC_API_KEY=<ANTHROPIC_API_KEY>     # Claude Sonnet 4.5
OPENAI_API_KEY=<OPENAI_API_KEY>            # OpenAI Realtime API
SUPABASE_URL=https://...         # Database
SUPABASE_SERVICE_ROLE_KEY=<SUPABASE_SERVICE_ROLE_KEY>    # Service role for PAM operations
```
