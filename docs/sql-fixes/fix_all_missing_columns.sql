-- Fix All Missing Database Columns (Problem #8)
-- Safe to run multiple times (idempotent with IF NOT EXISTS guards)
-- Run this in Supabase SQL Editor

-- ============================================================================
-- 1. PAM Savings Tables (complete schema)
-- ============================================================================
...
-- Savings events table with ALL required columns
...
ALTER TABLE public.pam_savings_events
    ADD COLUMN IF NOT EXISTS recommendation_id BIGINT REFERENCES pam_recommendations(id),
