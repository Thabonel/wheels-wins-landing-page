-- PAM Database Fix - Missing Tables Migration (TYPE-SAFE VERSION)
-- Execute this file in Supabase SQL Editor to fix 5 broken PAM tools
-- This version uses explicit type casts to avoid bigint vs UUID errors
...
-- TYPE-SAFE: Cast profiles.id to TEXT for comparison with auth.uid()::TEXT
...
-- TYPE-SAFE: Cast profiles.id to TEXT for comparison
