-- Migration: Create tables for data collector state tracking and metrics
...
-- Deduplicated location master table
CREATE TABLE IF NOT EXISTS trip_locations (
  id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
  name TEXT NOT NULL,
  latitude DECIMAL(10, 7) NOT NULL,
  longitude DECIMAL(10, 7) NOT NULL,
  location_hash TEXT UNIQUE GENERATED ALWAYS AS (
    MD5(CONCAT(ROUND(latitude::numeric, 4)::text, ',', ROUND(longitude::numeric, 4)::text))
  ) STORED,
  country TEXT,
  state_province TEXT,
