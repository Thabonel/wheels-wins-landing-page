-- Trip Template Enhancements Migration (Final Fixed Version)
...
-- RLS Policies for images (fixed to use user_id instead of id)
...
-- RLS Policies for scraper jobs (fixed to use user_id)
