...
ANTHROPIC_API_KEY=<ANTHROPIC_API_KEY>  # PRIMARY before Gemini
OPENAI_API_KEY=<OPENAI_API_KEY>         # FALLBACK before Gemini
...
VITE_ANTHROPIC_API_KEY=<ANTHROPIC_API_KEY>  # PRIMARY before Gemini
```
